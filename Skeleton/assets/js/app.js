...
if (!svgArea.empty()){
 ...
 // SVG wrapper dimensions are determined by the current width and
    ...
    function rendeCircles(circlesGroup, newXScale, newYScale, chosenXAxis, chosenYAxis) {
...
d3.csv(file).then(sucessHandle, errorHandle);

function errorHandle(error) {
    throw err;

}
function sucessHandle(demoData) {

    //Step1: Parse Data/Cast as numbers
